...
public class recepientActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(recepientActivity.this , LoginActivity.class);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(adr)){
                    telephone.setError("adresse is required");
                }
                if (group.equals("select your blood group")){
                    Toast.makeText(recepientActivity.this,"select a blood group",Toast.LENGTH_SHORT).show();
                }
                else {
